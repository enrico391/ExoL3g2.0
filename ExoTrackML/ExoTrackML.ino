...
void setup() {
    ...
    */
    ...
    if (dataSet) {
      dataSet.println("\"index\",\"timeReal\",\"AccYHip\",\"GyroYHip\",\"AccYKnee\",\"GyroYKnee\",\"Occupancy\""); // ay2 gy2  --> ginocchio,   ay gy --> anca
      }
    else {
